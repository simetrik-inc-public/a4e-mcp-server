...
class DevManager:
    ...
    def start_dev_server(project_dir: Path, port: int = 5000, auth_token: Optional[str] = None) -> Dict[str, Any]:
        ...
        # We assume dev_runner.py is in the parent directory of this file's parent (a4e_mcp/dev_runner.py)
        # utils/dev_manager.py -> a4e_mcp/utils/dev_manager.py
        # We need a4e_mcp/dev_runner.py
        
        # Get the package root (a4e_mcp)
